...
async function main() {
  ...
  const products = [
    ...
    },
    {
      ...
      price: 1799.99,
      image: '/assets/products/lenovo-thinkpad-x1.jpg',
      stock: 28,
      brand: 'Lenovo',
      model: 'X1 Carbon',
      categoryId: cat['Laptops'],
    ...
    },
    {
      ...
      price: 429.99,
      image: '/assets/products/bose-quietcomfort-ultra.jpg',
      stock: 35,
      brand: 'Bose',
      model: 'QC Ultra',
      categoryId: cat['Headphones'],
    },
    {
      ...
      price: 379.99,
      image: '/assets/products/sennheiser-momentum-4.jpg',
      stock: 25,
      brand: 'Sennheiser',
      model: 'Momentum 4',
      categoryId: cat['Headphones'],
    ...
    // Smartwatches (3)
    {
      ...
      price: 399.99,
      image: '/assets/products/apple-watch-series-9.jpg',
      stock: 55,
      brand: 'Apple',
      model: 'Series 9',
    ...
    },
    {
      ...
      price: 299.99,
      image: '/assets/products/samsung-watch-6.jpg',
      stock: 40,
      brand: 'Samsung',
      model: 'Watch 6',
      categoryId: cat['Smartwatches'],
    },
    {
      ...
      price: 699.99,
      image: '/assets/products/garmin-fenix-7.jpg',
      stock: 20,
      brand: 'Garmin',
      model: 'Fenix 7',
      categoryId: cat['Smartwatches'],
    ...
    },
    {
      ...
      price: 99.99,
      image: '/assets/products/logitech-mx-master.jpg',
      stock: 70,
      brand: 'Logitech',
      model: '3S',
      categoryId: cat['Accessories'],
    },
    {
      ...
      price: 59.99,
      image: '/assets/products/belkin-usbc-hub.jpg',
      stock: 120,
      brand: 'Belkin',
      model: '7-in-1',
      categoryId: cat['Accessories'],
